              ...
              <div className="space-y-4">
                <div className="glass rounded-xl p-6">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-display text-sm font-bold text-white mb-1">Companie</h3>
                      <p className="text-sm text-white/70">{brand.legalName}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass rounded-xl p-6">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-display text-sm font-bold text-white mb-1">Adresă</h3>
                ...
                <div className="glass rounded-xl p-6">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-display text-sm font-bold text-white mb-1">Telefon</h3>
                      <a href={`tel:${brand.phone.replace(/\s/g, "")}`} className="text-sm text-white/70 hover:text-gold transition-colors block">{brand.phone}</a>
                      <a href={`tel:${brand.agentPhone}`} className="text-sm text-white/70 hover:text-gold transition-colors block">Agent: {brand.agentPhone}</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass rounded-xl p-6">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-display text-sm font-bold text-white mb-1">Email</h3>
                      <a href={`mailto:${brand.email}`} className="text-sm text-white/70 hover:text-gold transition-colors block">{brand.email}</a>
                      <a href={`mailto:${brand.agentEmail}`} className="text-sm text-white/70 hover:text-gold transition-colors block">Agent: {brand.agentEmail}</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass rounded-xl p-6">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-display text-sm font-bold text-white mb-1">Program de lucru</h3>
                      <p className="text-sm text-white/70">{brand.program}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <label htmlFor="gdpr-contact" className="text-xs text-white/70">
